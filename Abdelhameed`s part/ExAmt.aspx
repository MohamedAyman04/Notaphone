...
<body style="background-color: #D4D9D5;">
    <form id="form1" runat="server">
        ...
        <br />
        <br />
        <asp:Button ID="Button1" runat="server" Text="Show amount" CssClass="custom-button" OnClick="Button1_Click1" />
        <br />
        <br />
        <div style="font-size: 20px; color: #007BFF">
            Remaining amount : <asp:Label ID="Label2" runat="server" Text="Label"></asp:Label>
        </div>
        <br />
        <br />
        <br />
